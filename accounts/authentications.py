...
def get_authenticated_user(cerdential: HTTPAuthorizationCredentials = Depends(security)) -> int:
    ...
    try:
        ...
        raise HTTPException(detail="Decode faild", status_code=status.HTTP_401_UNAUTHORIZED)
